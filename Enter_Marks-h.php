...
<tr>
<td><h1><x>S</x>ubject:</td><td></h1><select name="subject" id='subject'>
<?php
...
<tr>
<td><h1><x>E</x>xam:</h1></td><td><select name="exam" id='exam'>
<?php
$result->data_seek(0);
while($row=$result->fetch_assoc())
{
...
<tr><td><h1><x>M</x>.Marks:</h1></td>
<td><input style='width:120px;' type='number' name='tmark' min='0' value=100 required></td>
</tr>
